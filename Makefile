...
# ../hadoop-3.3.6/bin/hadoop jar build.jar MapReduce input/us-counties-2020.csv input/2020_election_data/president_county_candidate.csv input/2020_election_data/president_state.csv output
